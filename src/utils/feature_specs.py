...
def _build_specs() -> dict[str, FeatureSpec]:
    ...
    return {
        "stft": FeatureSpec(
            ...
            feature_key="stft",
            default_data_dir=str(Path(base_dir).parent / "DroneRFa_stft_awgn_random_17class_h5"),
            checkpoint_name="best_stft_17class_model.pth",
            cm_array_name="stft_17class_confusion_matrix.npy",
            cm_image_name="stft_17class_confusion_matrix.png",
        ...
        "cpp": FeatureSpec(
            ...
            feature_key="cpp",
            default_data_dir=str(Path(base_dir).parent / "DroneRFa_cpp_awgn_random_17class_h5"),
            checkpoint_name="best_cpp_17class_model.pth",
            cm_array_name="cpp_17class_confusion_matrix.npy",
            cm_image_name="cpp_17class_confusion_matrix.png",
