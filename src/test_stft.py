...
Usage:
  python src/test_spec.py --data-dir /path/to/h5_dir
  python src/test_spec.py --data-dir /path/to/h5_dir --gpu 1
  python src/test_spec.py --data-dir /path/to/h5_dir --model-path checkpoints/best_model.pth
"""
...
def parse_args():
    ...
    parser.add_argument("--cm-image-path", type=str, default=None,
                        help="Path to save confusion matrix image (default: checkpoints/confusion_matrix.png)")
